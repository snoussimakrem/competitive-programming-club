...
import { Mail, Users, Award, ArrowRight, CheckCircle } from 'lucide-react';
...
const CTASection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Also save to a JSON file simulation (in real app, this would be sent to backend)
            ...
            <div className="signup-card">
              ...
              <form className="signup-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <select id="level" className="form-select" value={formData.level} onChange={handleChange} required>
                ...
                <p className="form-note">
                  By joining, you agree to our Terms and Privacy Policy. We'll never spam you.
                </p>
              </form>

              <div className="social-signup">
                <p className="social-label">Or sign up with:</p>
